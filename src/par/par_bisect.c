...
/***************************** BEGIN EXECUTION ******************************/
  ...
  {
    /* Describe struct bisector to MPI. Add MPI_Type_create_resized at the end just to be safe. */
    ...
    types[2] = MPI_INT;
    types[4] = MPI_Type_create_resized;
    ...
    MPI_Type_create_struct(5, lengths, ind, types, &med_type);
